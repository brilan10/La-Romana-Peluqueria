  ...
  if (selectedClient) {
    ...
    return (
      <div style={{ padding: '20px 0' }}>
        <button onClick={() => setSelectedClient(null)} style={{ background: 'transparent', border: 'none', padding: 0, marginBottom: '20px', cursor: 'pointer' }}>
          <span className="btn-romana"><span className="icon-separator">⬅️</span> VOLVER A AGENDA</span>
        </button>
        ...
        <div className="card" style={{ marginBottom: '20px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
             <button onClick={handleDerivarCaja} className="btn-romana" style={{ flex: 1, backgroundColor: 'transparent' }}>
                <span className="icon-separator">📥</span> DERIVAR A CAJA
             </button>
             <button onClick={handleCobrarAqui} className="btn-romana" style={{ flex: 1 }}>
                <span className="icon-separator">💰</span> COBRAR AQUÍ
             </button>
          </div>
        </div>
      </div>
  ...
  return (
    <div style={{ padding: '20px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px' }}>
        ...
        <div>
           <button className="btn-romana" style={{ fontSize: '0.8rem', padding: '5px 15px', marginRight: '10px' }} onClick={() => setShowExpress(!showExpress)}>
             <span className="icon-separator" style={{ minHeight: '25px', fontSize: '1.2rem', paddingRight: '10px', marginRight: '10px' }}>⚡</span> AGENDAR
           </button>
